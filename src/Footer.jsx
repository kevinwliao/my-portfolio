    ...
    <footer className="footer items-center p-4 bg-base-100 text-neutral-content">
      ...
      <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
        <a
          ...
          href="https://www.linkedin.com/in/kevin-liao-87084b16b"
        >
          <svg
        ...
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://soundcloud.com/kevin-liao-775540098?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
        ...
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://musescore.com/user/61065196"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
