  ...
  return (
    <section className="bg-base-200 px-8 sm:px-36 md:px-48 lg:px-64 xl:px-80">
      <Subsection id="acoustic" title="Acoustic Compositions">
        ...
        <div className="mb-6" id="piece">
          <div className="pb-5">
            <h2 className="text-3xl font-extrabold">Glass Étude</h2>
            <h3 className="text-xl font-light text-slate-500">Piano, 2022</h3>
          </div>
          <Player url="https://soundcloud.com/kevin-liao-775540098/glass-etude?si=8e201fa2a11f4b1d9701e0578116878c&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing" />
      ...
      >
        <div className="mb-6" id="piece">
          ...
          <Player url="https://soundcloud.com/kevin-liao-775540098/nightmare-library?si=74adf6351ffd453e86d08d3f58ffa0bc&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing" />
          <p className="mb-2">
